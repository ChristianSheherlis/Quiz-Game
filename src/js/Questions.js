const questionBank = [
  ...
  {
    question:
      "Who is the only person to win Nobel Prizes in two separate sciences?",
    answers: [
      "Marie Curie",
      "Albert Einstein",
      "Neil DeGrasse Tyson",
  ...
  },
  {
    ...
    answers: [
      ...
      "An island",
      "Nothing",
      "A rock with a couple of seagulls on it",
    ],
  ...
  {
    question:
      "What territory must the UK lose for the sun to set on the British Empire?",
    answers: [
      "The Cayman Islands",
  ...
  {
    question:
      "What actor put a life-size statue of themselves in the window of their house?",
